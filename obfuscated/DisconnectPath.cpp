bool as43adf(int s2vsaassssdwe, int s2vsadfaassssdwe, vector<vector<int>> &s2vswe)
{
    ...
    if (s2vsaassssdwe == s2vsasdwe - 1 and s2vsadfaassssdwe == s2vsaassdwe - 1)
        return true;
    if (s2vsaassssdwe < 0 or s2vsaassssdwe >= s2vsasdwe or s2vsadfaassssdwe < 0 or s2vsadfaassssdwe >= s2vsaassdwe)
        return false;
